...
SECRET_KEY = 'Key for CYCU-CTRL-DMOJ-SITE'
...
SITE_NAME = 'CTRL OJ'
SITE_LONG_NAME = 'CTRL Online Judge'
SITE_ADMIN_EMAIL = 'cyee501a@gmail.com'
...
BRIDGED_JUDGE_ADDRESS = [('172.25.0.2', 9999)]
#BRIDGED_JUDGE_HOST = 'host'
#BRIDGED_JUDGE_PORT = 9999

# The bridged daemon bind address and port to communicate with the site.
BRIDGED_DJANGO_ADDRESS = [('172.25.0.2', 9998)]
...
EVENT_DAEMON_GET = 'ws://172.25.0.2/event/'
EVENT_DAEMON_GET_SSL = 'wss://172.25.0.2/event/'  # Optional
EVENT_DAEMON_POLL = '/channels/'
